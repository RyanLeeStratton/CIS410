...
public class CRT : MonoBehaviour
{
    ...
    void Update()
    {
        healthDistort = playerscript.health-20;
        healthDistort2 = playerscript.health;
        //print(healthDistort2);
        Distortion = healthDistort *0.25f;
		if (healthDistort2 > 10) {
			Gamma = (healthDistort * 0.008f) + 1f;
			//rgb1.g = (healthDistort2 * 10) / 255;
			//rgb1.b = (healthDistort2 * 10) / 255;
		}
		if (healthDistort2 > 7) {
			rgb1.g = (healthDistort2 * 10) / 255;
			rgb1.b = (healthDistort2 * 10) / 255;
